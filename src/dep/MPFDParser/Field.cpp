...
MPFD::Field::Field(const std::string key) : key_(key) {
    type = 0;
    FieldContent = NULL;
...
unsigned long MPFD::Field::GetFileContentSize() const {
    if (type == 0) {
...
char * MPFD::Field::GetFileContent() const {
    if (type == 0) {
...
std::string MPFD::Field::GetTextTypeContent() const {
    if (type == 0) {
...
std::string MPFD::Field::GetTempFileName() const {
    if (type == 0) {
...
std::string MPFD::Field::GetFileName() const {
    if (type == 0) {
...
std::string MPFD::Field::GetFileMimeType() const {
    if (type == 0) {
