...
#define MY_LOG4CXX_TRACE(logger, ...) LOG_TRACE(__VA_ARGS__)
#define MY_LOG4CXX_DEBUG(logger, ...) LOG_DEBUG(__VA_ARGS__)
#define MY_LOG4CXX_INFO(logger, ...) LOG_INFO(__VA_ARGS__)
#define MY_LOG4CXX_WARN(logger, ...) LOG_WARN(__VA_ARGS__)
#define MY_LOG4CXX_ERROR(logger, ...) LOG_ERROR(__VA_ARGS__)
#define MY_LOG4CXX_ASSERT(logger, ...) LOG_FATAL(__VA_ARGS__)
#define MY_LOG4CXX_FATAL(logger, ...) LOG_FATAL(__VA_ARGS__)
